                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            <h3 class="display-4">CPX LOGIN</h3>
                            {{-- <p class="text-muted mb-4">Create a login split page using Bootstrap 4.</p> --}}
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <div class="form-group mb-3">
                                    <input id="username" name="username" type="username" placeholder="Email/Username" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4 @error('username') is-invalid @enderror">
                                    @error('username')
