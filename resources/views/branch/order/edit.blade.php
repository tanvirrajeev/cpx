        ...
        <div class="col-md-9">
            <div class="card">
              {{-- Validation Error Message --}}
                ...
                @endif
                <div class="card-header bg-dark"><h3>{{ __('ORDER EDIT') }}</h3></div>
                ...
                <div class="card-body bg-orange">
                    ...
                    <form action="/branch/order/{{ $order->id}}" method="POST" id="orderform">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="ecomsppngpriority" id="ecomsppngpriorityq">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="ecompurchaseamto" name="ecompurchaseamt" value="{{$order->ecompurchaseamt}}">
                            </div>
                            <div class="col-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ecomprdtraclnke" name="ecomprdtraclnk" value="{{$order->ecomprdtraclnk}}">
                        </div>
