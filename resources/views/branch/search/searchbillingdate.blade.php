        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="get" action="{{ route('branch.search.searchbillingexport') }}">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <button type="button" name="refresh" id="refresh" class="btn bg-green btn-sm">Reset</button>
...
<script>
    ...
    //    bDestroy: true,
       ...
       order: [0, 'desc'],
       ajax: {
        url:'{{ route("branch.search.searchbillingdate") }}',
